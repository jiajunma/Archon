...
**Before you search:** check [mathlib-unavailable-theorems.md](mathlib-unavailable-theorems.md) — if the theorem is in a domain with immature infrastructure, searching is futile. Choose an alternative approach instead.
